...
[Edit this page on GitHub](https://github.com/skyscanner/backpack-docs/edit/master/docs/src/static-pages/status.md)
    `} />)},{path: "/using/updating-this-website", component: () => (<MarkdownPage title="Updating this website" subtitle="Backpack belongs to everyone at Skyscanner. Changes are welcomed from anybody." content={`
## Before you start
...
[Edit this page on GitHub](https://github.com/skyscanner/backpack-docs/edit/master/docs/src/static-pages/website-contribution-guide.md)
    `} />)}];