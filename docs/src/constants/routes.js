...
export const FORM_VALIDATION = '/components/form-validation';
...
export const RESET_ANALYTICS = '/reset-analytics';
export const TYPOGRAPHY_TOKENS_MIGRATION_GUIDE =
  '/typography-tokens-migration-guide';
export const TYPOGRAPHY_BPK_TEXT_MIGRATION_GUIDE =
  '/typography-bpk-text-migration-guide';
// AUTOGENERATED
