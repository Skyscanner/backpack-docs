...
Aligning an icon within text with textStyle "base" can be done using <Code>withAlignment</Code>, providing suitable spacings (see the [Typesetting section](/tokens/typesetting)).
