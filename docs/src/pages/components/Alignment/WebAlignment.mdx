...
} from '../../../../../backpack/examples/bpk-component-icon/examples';
...
Aligning an icon within text with textStyle "base" can be done using `withAlignment`, providing suitable spacings.
