...
githubPath: Calendar
fileName: Calendar/IOSCalendar.mdx
---
...
import screenshotPrices from 'backpack-ios/screenshots/iPhone 8-calendar___with-prices_lm.png';
import screenshotPricesDm from 'backpack-ios/screenshots/iPhone 8-calendar___with-prices_dm.png';
...
<IOSComponentScreenshots
  lightMode={screenshotPrices}
  darkMode={screenshotPricesDm}
  altText="Calendar for iOS with price labels shown below each cell"
/>
