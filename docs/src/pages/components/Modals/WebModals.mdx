...
import { DefaultExample, CloseButtonTextExample, FullScreenExample } from 'backpack/examples/bpk-component-modal/examples';
import Readme from 'backpack/packages/bpk-component-modal/README.md';
