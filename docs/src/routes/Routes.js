...
import ColorsPage from '../pages/guidelines/Colors';
import AccessibilityPage from '../pages/guidelines/Accessibility';
import TypographyPage from '../pages/guidelines/Typography';
import TypesettingPage from '../pages/tokens/Typesetting';
import RadiiPage from '../pages/tokens/Radii';
import ShadowsPage from '../pages/tokens/Shadows';
import BordersPage from '../pages/tokens/Borders';
import SpacingsPage from '../pages/tokens/Spacings';
import AnimationPage from '../pages/tokens/Animation';
import ZIndexesPage from '../pages/tokens/ZIndexes';
import CopywritingPage from '../pages/guidelines/Copywriting';
import GraphicDevicesPage from '../pages/guidelines/GraphicDevices';
import ToneOfVoicePage from '../pages/guidelines/ToneOfVoice';
import StrategyPage from '../pages/guidelines/Strategy';
import PhotographyPage from '../pages/guidelines/Photography';
import ShadowsGuidelinesPage from '../pages/guidelines/Shadows';
import IllustrationPage from '../pages/guidelines/Illustration';
import IconographyPage from '../pages/guidelines/Iconography';
import LogoPage from '../pages/guidelines/Logo';
import InUsePage from '../pages/guidelines/InUse';
...
import BagCheckPage from '../pages/BagCheck';
import { GridColumnDemoPage, GridOffsetDemoPage } from '../pages/GridDemos';

import { using as autogeneratedUsingPages } from './generated/Routes';
