...
import TypographyTokensMigrationGuidePage from '../pages/TypographyMigrationGuides';
...
export const ROUTES_MAPPINGS = [
  ...
  {
    path: ROUTES.TYPOGRAPHY_TOKENS_MIGRATION_GUIDE,
    component: TypographyTokensMigrationGuidePage,
  },
