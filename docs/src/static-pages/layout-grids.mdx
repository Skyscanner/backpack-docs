...
| Name           | Scale        | Margins |
| -------------- | ------------ | ------- |
| Small Mobile   | 320-359px    | 16px    |
| Mobile         | 360-512px	| 24px    |
| Small Tablet   | 513-768px	| 24px    |
| Tablet         | 769-1024px	| 32px    |
| Desktop        | 1025-1280px	| 48px    |
| Desktop Large  | 1281px +	    | 48px    |
...
<iframe style={{border: '1px solid rgba(0, 0, 0, 0.1)'}} width="800" height="1200" src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2FKXf2gHNLDe2cXWUoHl4cTX%2FBackpack-Foundations%3Fnode-id%3D2081%253A531" allowfullscreen></iframe>
