...
* If you are using typography tokens and wish to migrate to mixins instead, have a look at this guide - [Typography tokens migration](/typography-migration-guide).
* If you are using BpkText component and wish to remove the deprecated weight property, have a look at this guide.